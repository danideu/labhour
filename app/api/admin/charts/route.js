...
export async function GET() {
  ...
  try {
    // Hours per project (last 30 days)
    const hoursPerProject = await query(`
    ...
    // Absences by status
    const absencesByStatus = await query(`
    ...
    const absencesByType = await query(`
